...
if int(sublime.version()) < ST_REQUIRED_MINIMUM_VERSION:
    ...
    # fmt: off
    from .sshubl.commands import (  # type: ignore[unresolved-import]  # pylint: disable=unused-import
    ...
    from .sshubl.listeners import (  # type: ignore[unresolved-import]  # pylint: disable=unused-import
        EventListener,
        ViewEventListener,
        plugin_loaded,
        plugin_unloaded,
